...
#wget -t 0 -c -b https://storage.googleapis.com/thumos14_files/TH14_validation_set_mp4.zip -O videos_val.zip
#wget -t 0 -c -b https://storage.googleapis.com/thumos14_files/TH14_Test_set_mp4.zip -O videos_test.zip
